...
# [reality]
# listen       = "0.0.0.0:443"
# dest         = "www.gstatic.com:443"   # real site shown to probes
# server_names = ["www.gstatic.com"]
...
[tls]
sni = "s3.amazonaws.com"   # SNI in TLS ClientHello (optional; defaults to s3.amazonaws.com)
...
# [reality]
# sni        = "www.gstatic.com"   # must match the server's dest / server_names
